...
//Preprocessor
//-------------------------------------------------------------------------
#define HELPER_CLASS_NAME "com/sample/model/NDKHelper" //Class name of helper function
 ...
 */
int Engine::InitDisplay(int width, int height)
{
...
//========================================================================================
void Engine::engine_handle_cmd(android_app* app, int32_t cmd)
{
    ...
    switch (cmd)
    {
        case APP_CMD_INIT_WINDOW:
            if (app->window != NULL)
            {
                ...
                LOGE("Camera initialized at resolution %dx%d", camera_resolution.width, camera_resolution.height);
                
                //Added
                // engine->InitDisplay((int)(view_width/scale), (int)(view_height/scale));
            }
            break;
...
void android_main(android_app* app)
{
    ...
    app->userData = &engine;
    app->onAppCmd = Engine::engine_handle_cmd;
    engine.app = app;
//Added
